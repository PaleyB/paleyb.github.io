...
createCollectable("kennedi", 100, 300);
...
createCannon("left", 200, 1000, delay=1 , widith= 10, height= 45);
createCannon("right", 200, 1000);
createCannon("top", 300, 400, delay=3, widith= 23, height = 13);
